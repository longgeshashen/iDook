...
//		imageArray=[[NSArray arrayWithArray:tempArray] retain];
        imageArray=[[NSArray arrayWithArray:imgArr] retain];
		viewSize=rect;
        NSUInteger pageCount=[imageArray count];
        scrollView=[[UIScrollView alloc]initWithFrame:CGRectMake(0, 0, viewSize.size.width, viewSize.size.height)];
        scrollView.pagingEnabled = YES;
        scrollView.contentSize = CGSizeMake(80 * pageCount, viewSize.size.height);
        ...
        for (int i=0; i<pageCount; i++) {
            ...
            [imgView setFrame:CGRectMake(75*i, 0,70, viewSize.size.height)];
            imgView.tag=i;
